...
from flask_jwt_extended import JWTManager, create_access_token #JWT is a method of authentication that allows us to create secure tokens for users to acceess protected routes
